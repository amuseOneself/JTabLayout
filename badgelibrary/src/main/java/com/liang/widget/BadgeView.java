...
public class BadgeView extends android.support.v7.widget.AppCompatTextView {
    ...
    public void setDragListener(OnDragListener dragListencer) {
        this.mOnDragListener = dragListencer;
    }
    ...
    public BadgeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mStroke = typedArray.getDimensionPixelSize(R.styleable.BadgeView_strokeWidth, dip2px(getContext(), 2));
